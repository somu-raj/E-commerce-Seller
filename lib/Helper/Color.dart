...
const Color grad1Color = Color(0xff2596be);
const Color grad2Color = Color(0xffFFFFFF);
...
const Color darkColor = Color(0xff2596be);
const Color darkColor2 = Color(0xff2596be);
