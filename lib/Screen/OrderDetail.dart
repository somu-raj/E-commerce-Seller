...
//========================= getDeliveryBoy API =================================
  ...
  openWhatsapp(String whatsNumber) async {
    var whatsapp = "${whatsNumber}";
    // var whatsapp = "+919644595859";
    var whatsappURl_android = "whatsapp://send?phone=" + whatsapp +
        "&text=Hello, I am messaging from Delris Tech App, I am interested in your products, Can we have chat? ";
        ...
        child: Column(
          ...
          children: [
            FloatingActionButton(
              ...
              onPressed: () async {
               // openWhatsapp(tempList[0].mobile!);
